    ...
    const recentGames = [
        {
            id: "1",
            title: "Breaking Bad",
            // Utiliser une URL en ligne pour l'image au lieu d'un fichier local
            image: { uri: "https://via.placeholder.com/120x60/6A5ACD/FFFFFF?text=Breaking+Bad" },
            progress: 30,
        },
        {
            id: "2",
            ...
            // Utiliser une URL en ligne pour l'image au lieu d'un fichier local
            image: { uri: "https://via.placeholder.com/120x60/FF5733/FFFFFF?text=Logos" },
            progress: 65,
        },
        {
            id: "3",
            title: "Name the Flag",
            // Utiliser une URL en ligne pour l'image au lieu d'un fichier local
            image: { uri: "https://via.placeholder.com/120x60/33A8FF/FFFFFF?text=Flags" },
            progress: 20,
        },
    ]
    ...
    const gameCategories = [
        {
            ...
            // Utiliser une URL en ligne pour l'image au lieu d'un fichier local
            image: { uri: "https://via.placeholder.com/120x120/28AF6E/FFFFFF?text=Culture" },
        ...
        },
        {
            ...
            // Utiliser une URL en ligne pour l'image au lieu d'un fichier local
            image: { uri: "https://via.placeholder.com/120x120/7D04FC/FFFFFF?text=Valentine" },
