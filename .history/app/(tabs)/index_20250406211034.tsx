    ...
    >
      <ScrollView style={styles.container} contentContainerStyle={styles.content}>
        ...
        <View style={styles.header}>
          ...
          <TouchableOpacity style={[styles.profileButton, { backgroundColor: 'rgba(255, 255, 255, 0.15)' }]}>
        ...
        <View style={styles.actionsContainer}>
          <TouchableOpacity 
            style={[styles.mainButton, { backgroundColor: 'rgba(255, 255, 255, 0.2)' }]} 
          ...
          <View style={styles.codeInputContainer}>
            ...
            >
              <Feather name="arrow-right" size={24} color={colors.backgroundDarker} />
            </TouchableOpacity>
          </View>
        </View>
        ...
        <View style={styles.typeContainer}>
          <TouchableOpacity style={[styles.typeCard, { backgroundColor: '#1E3A6E' }]}>
            <Text style={[styles.typeTitle, { color: colors.tertiary }]}>Culture Générale</Text>
          </TouchableOpacity>
          
          <TouchableOpacity style={[styles.typeCard, { backgroundColor: '#8E1F3E' }]}>
