...
import { answerValidator, voteValidator, nextRoundValidator } from '#validators/game'
...
export default class GamesController {
      ...
      return response.ok({
        ...
        data: {
          ...
          currentQuestion: currentQuestion
            ? {
                ...
                targetPlayer: {
                  ...
                  display_name: currentQuestion.targetPlayer.display_name,
          ...
          answers: answers.map((answer) => ({
            ...
            playerName: answer.user.display_name || answer.user.username,
  ...
  async submitAnswer({ request, response, auth, params }: HttpContext) {
    try {
      ...
      // Récupérer la salle pour les événements SSE
      const room = await Room.find(game.roomId)

      // Émettre un événement SSE pour notifier les autres joueurs
      transmit.emit(`game:${gameId}`, {
        type: 'new_answer',
        answer: {
          id: answer.id,
          content: answer.content,
        ...
        transmit.emit(`game:${gameId}`, {
          ...
          question: {
            ...
            targetPlayer: {
              ...
              display_name: targetPlayer.display_name,
            },
          },
        })
